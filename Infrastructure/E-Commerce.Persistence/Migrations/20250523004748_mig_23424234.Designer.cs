...
namespace E_Commerce.Persistence.Migrations
{
    ...
    [Migration("20250523004748_mig_23424234")]
    partial class mig_23424234
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("OrderPaymentAddressId")
                        .HasColumnType("int");

                    b.Property<int?>("OrderPaymentCardId")
                        .HasColumnType("int");

                    b.Property<int?>("OrderPaymentOtherId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderPaymentAddressId");

                    b.HasIndex("OrderPaymentCardId");

                    b.HasIndex("OrderPaymentOtherId");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.OrderPaymentAddress", b =>
                {
                    b.Property<int>("OrderPaymentAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderPaymentAddressId"));
                    ...
                    b.HasKey("OrderPaymentAddressId");

                    b.ToTable("OrderPaymentAddresses");
                });

            modelBuilder.Entity("E_Commerce.Domain.Entities.OrderPaymentCard", b =>
                {
                    b.Property<int>("OrderPaymentCardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderPaymentCardId"));

                    b.Property<string>("OrderCardCVV")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("OrderCardDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("OrderCardName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrderCardNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("OrderPaymentCardId");

                    b.ToTable("OrderPaymentCards");
                });

            modelBuilder.Entity("E_Commerce.Domain.Entities.OrderPaymentOther", b =>
                {
                    b.Property<int>("OrderPaymentOtherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderPaymentOtherId"));
                    ...
                    b.HasKey("OrderPaymentOtherId");

                    b.ToTable("OrderPaymentOthers");
                });
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Quarter", b =>
                {
                    b.Property<int>("QuarterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.District", b =>
                {
                    b.HasOne("E_Commerce.Domain.Entities.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.Domain.Entities.Quarter", "Quarter")
                        .WithMany()
                        .HasForeignKey("QuarterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.Domain.Entities.Town", "Town")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Order", b =>
                {
                    b.HasOne("E_Commerce.Domain.Entities.OrderPaymentAddress", "OrderPaymentAddress")
                        .WithMany()
                        .HasForeignKey("OrderPaymentAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.Domain.Entities.OrderPaymentCard", "OrderPaymentCard")
                        .WithMany()
                        .HasForeignKey("OrderPaymentCardId");

                    b.HasOne("E_Commerce.Domain.Entities.OrderPaymentOther", "OrderPaymentOther")
                        .WithMany()
                        .HasForeignKey("OrderPaymentOtherId");

                    b.Navigation("OrderPaymentAddress");

                    b.Navigation("OrderPaymentCard");

                    b.Navigation("OrderPaymentOther");
                });
