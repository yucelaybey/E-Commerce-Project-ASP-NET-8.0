...
{
    public class _RecommendedFavoritesComponentPartial:ViewComponent
    {
        private readonly HttpClient _httpClient;

        public _RecommendedFavoritesComponentPartial(HttpClient httpClient)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            try
            {
                ...
                var randomProducts = GetRandomItems(products, 10);
