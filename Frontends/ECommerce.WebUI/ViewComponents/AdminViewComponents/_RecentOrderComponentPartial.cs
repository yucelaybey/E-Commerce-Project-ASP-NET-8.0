...
using Newtonsoft.Json; // Bu satırı ekledik

namespace ECommerce.WebUI.ViewComponents.AdminViewComponents
{
    public class _RecentOrderComponentPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _RecentOrderComponentPartial(IHttpClientFactory httpClientFactory)
        {
