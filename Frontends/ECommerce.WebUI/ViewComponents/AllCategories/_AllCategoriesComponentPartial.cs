...
namespace ECommerce.WebUI.ViewComponents.AllCategories
{
    public class _AllCategoriesComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _AllCategoriesComponentPartial(IHttpClientFactory httpClientFactory)
        {
